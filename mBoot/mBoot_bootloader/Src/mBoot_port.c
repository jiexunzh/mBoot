/**
 * @file mBoot_port.c
 * @brief 本文件定义了实现mBoot所需的接口函数，使用者需根据实际硬件提供
 * @author ZJX
 * @date 2025-06-18
 * @version 1.0
 */
...
/**
 * @brief  mBoot串口是否已经接收到了数据（接收寄存器非空）
 * @retval 1: 已接收到数据
 *         0: 未接收到数据
 */
