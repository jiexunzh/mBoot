...
#define CRC16_CCITT_POLY16 0x1021  // CRC16-CCITT 使用的多项式，预计算 CRC 表时使用
...
/**
 * @brief  CRC-ccitt校验码生成函数
 * @param  pbuf 数据指针
 * @param  len 数据长度
 * @retval crc16 低八位crc_l，高八位crc_h
 */
uint16_t crc16_ccitt(uint8_t* pbuf, unsigned int len)
{
